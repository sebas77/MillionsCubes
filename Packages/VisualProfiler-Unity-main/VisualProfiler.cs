...
using Windows.System;
    ...
    public sealed class VisualProfiler : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            Vector2 defaultWindowRotation = new Vector2(0.0f, 0.0f);
        ...
        private void LateUpdate()
        {
            if (IsVisible)
            {
                ...
                accumulatedFrameTimeGPU += WEOProfiler.ProfilerWatch.lastGPU;
                accumulatedFrameTimeCPU += WEOProfiler.ProfilerWatch.lastCPU;
